...
groups = [
        ...
        Group(name="4",label=""),
        Group(name="5",label=""),
        Group(name="6",label="󰒓"),
        Group(name="7",label="󰀄"),
        Group(name="8",label=""),
        Group(name="9",label="󱆃"),
        ]
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Volume(fmt="{}",  **rect("#3c3836")                      ),
                widget.Spacer(length=8),

                widget.Clock(format="%a",         **rect("#689d6a"), foreground="#282828", font="monospace Bold"),
                widget.Clock(format="%a %I:%M %p",**rect("#3c3836"),                       font="monospace Bold"),
